...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { Password: @login.Password, Userid: @login.Userid } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { Password: @login.Password, Userid: @login.Userid } }
